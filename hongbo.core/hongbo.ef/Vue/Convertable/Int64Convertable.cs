...
namespace hongbao.Vue.Convertable
{
    /// <summary>
    /// 根据 type，以及 property，
    /// 将 int64 类型自动转换为一个Vue客户端编辑组件（AbstractPropertyComponentAttribute）
    /// </summary>
    public class Int64Convertable : AbstractConvertable
    {
        ...
        public Int64Convertable(Type entityType, PropertyInfo property) : base(entityType, property)
        {

...
namespace hongbao.IOExtensions
{
    /// <summary>
    /// 串口通讯类;
    /// https://www.cnblogs.com/netlyf/p/4458927.html
    /// </summary>
    public class Rs232
    {
        ...
        public Rs232(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
        {
